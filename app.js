...
function logout(){ Bot.detenerPollingQR(); localStorage.removeItem(SESSION_KEY); state.user=null; state.token=''; state.pinBuffer=''; pintarPin(); showView('login'); }
