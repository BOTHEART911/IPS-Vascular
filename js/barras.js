/* ============================================================
   barras.js — CAPA 10 · Barras del dashboard que crecen
   ...
   ------------------------------------------------------------
   PAREJA   : ninguna (JS autónomo). Convive con conteo.js (8).
...
(function () {
  ...
  if (typeof orig !== 'function') {
    console.info('[barras] cargarDashboard no encontrada; capa inactiva.');
    return;
  }
  ...
  console.info('[barras] Barras del dashboard con crecimiento en cascada.');
})();
