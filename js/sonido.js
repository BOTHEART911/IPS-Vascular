/* ============================================================
   sonido.js — CAPA 3 · Sonido sin retardo (funcional)
   ...
   ------------------------------------------------------------
   PAREJA   : se "alinea" con vibracion.js (capa 2): al reproducir
...
(function () {
  ...
  if (!AC || !SONIDOS || typeof origSnd !== 'function') {
    console.info('[sonido] Web Audio no disponible; se mantiene el sonido original.');
    return;
  }
  ...
  console.info('[sonido] Sonido sin retardo activo (Web Audio, con respaldo a <audio>).');
})();
