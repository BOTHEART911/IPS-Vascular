/* ============================================================
   vibracion.js — CAPA 2 · Vibración / háptica (funcional)
   ...
   <script src="./js/vibracion.js"></script>
   ------------------------------------------------------------
   PAREJA   : queda "alineada" con sonido.js (la capa 3), de modo
...
(function () {
  ...
  if (!soportaVibrar) {
    console.info('[vibracion] Vibración no disponible en este dispositivo (típico en iOS). Capa inactiva.');
    return; // nada que hacer; las demás capas siguen intactas
  }
  if (reduce) {
    console.info('[vibracion] "Reducir movimiento" activo: háptica desactivada.');
    return;
  }
  ...
  console.info('[vibracion] Háptica activa (Android).');
})();
