/* ============================================================
   modales.js — CAPA 9 · Contenido de modales escalonado
...
(function () {
  ...
  if (reduce) { console.info('[modales] "Reducir movimiento" activo: inactiva.'); return; }
  if (!('animate' in Element.prototype)) { console.info('[modales] Web Animations API no disponible.'); return; }
  ...
  console.info('[modales] Contenido de modales escalonado activo.');
})();
