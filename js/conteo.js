/* ============================================================
   conteo.js — CAPA 8 · Conteo de números (funcional)
   ...
   ------------------------------------------------------------
   PAREJA   : ninguna (JS autónomo). Convive con barras.js (10).
...
(function () {
  ...
  if (!root) { console.info('[conteo] #dash-content no encontrado; capa inactiva.'); return; }
  ...
  console.info('[conteo] Conteo de enteros activo en el dashboard.');
})();
