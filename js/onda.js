/* ============================================================
   onda.js — CAPA 7 · Onda al tocar / ripple (decorativa)
   ...
   <script src="./js/onda.js"></script>
   ------------------------------------------------------------
   PAREJA   : onda.css (los estilos de la onda).
...
(function () {
  ...
  if (reduce) { console.info('[onda] "Reducir movimiento" activo: onda desactivada.'); return; }
  ...
  console.info('[onda] Onda al tocar activa.');
})();
