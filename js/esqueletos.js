/* ============================================================
   esqueletos.js — CAPA 5 · Esqueletos de carga (funcional)
   ...
   <script src="./js/esqueletos.js"></script>
   ------------------------------------------------------------
   PAREJA   : esqueletos.css (los estilos de las siluetas).
...
(function () {
  ...
  console.info('[esqueletos] Esqueletos activos en listas (el girador global sigue intacto).');
})();
