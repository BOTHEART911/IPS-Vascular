/* ============================================================
   jalar-recargar.js — CAPA 6 · Jalar para recargar / pull-to-refresh
   ...
   <script src="./js/jalar-recargar.js"></script>
   ------------------------------------------------------------
   PAREJA   : jalar-recargar.css (indicador + desactivar PTR nativo).
...
(function () {
  ...
  console.info('[jalar-recargar] Jalar para recargar activo (gesto táctil).');
})();
