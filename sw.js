/**
 * IPS VASCULAR — Service Worker  ·  v8 (Fase 8, 08/09/2026)
 * Cambios de la v7:
 *  - Todo lo que NO es de esta app (Apps Script, la fuente, SweetAlert2)
 *    sale del service worker de inmediato: lo maneja el navegador solo.
 *    Antes pasaba por aquí para nada y añadía un salto en cada llamada.
 *  - Nombre de caché nuevo: al instalarse borra la v7 sola.
 ...
 */
const CACHE_NAME = 'ips-vascular-v8';
const APP_SHELL = [
...
self.addEventListener('fetch', (event) => {
  ...
  /* Nada de fuera pasa por aquí (Apps Script, fuentes, SweetAlert2). */
  if (!propio) return;
